"""Alembic migration environment for Agent RAG.
...
# Import the Base from ingestion models to include all table metadata
...
config.set_main_option("sqlalchemy.url", database_config.async_database_url)
